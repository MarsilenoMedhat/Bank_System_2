...
class clsManagerUsers : protected clsScreen {
...
public:
    static void ShowManageUsersMenuScreen() {
        ...
        cout << " [4] Update user.\n";
        cout << " [5] Find user.\n";
        cout << " [6] Back to main menu screen.\n";
        cout << "========================================\n";
        _PerformManageUserMenuOption((clsManagerUsers::enManageUsersMenuOptions)_ReadManageUserMenuOption());
    }
};