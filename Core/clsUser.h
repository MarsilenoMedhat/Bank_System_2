...
private:
    ...
    static void _SaveUsersDataToFile(vector<clsUser> vUsers, string Seperator = "#//#") {
        fstream UsersDataFile("Data/Users.txt", ios::out);
    ...
    static vector<clsUser> _LoadUsersDataFromFile() {
        ...
        fstream UsersDataFile("Data/Users.txt", ios::in);
    ...
    void _AddUserDataToFile(string UserDataLine) {
        fstream UsersDataFile("Data/Users.txt", ios::in | ios::app);
        if (UsersDataFile.is_open()) {
...
public:
    ...
    static vector<stLoginRegister> GetLoginRegisterData() {
        ...
        fstream LoginRegisterDataFile("Data/LoginRegister.txt", ios::in);
    ...
    void RegisterLogin(clsUser ActiveUser) {
        fstream LoginFile("Data/LoginRegister.txt", ios::in | ios::app);
